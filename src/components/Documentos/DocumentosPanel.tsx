...
export default function DocumentosPanel() {
  ...
  const [filteredDocumentos, setFilteredDocumentos] = useState<Documento[]>(mockDocumentos);
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">
            Gerencie seus documentos pessoais, cadastros, contratos e comprovantes
          </p>
        </div>
        <button className="flex items-center justify-center gap-2 px-4 py-2 bg-[#00A651] hover:bg-[#008c44] text-white rounded-lg font-medium transition-colors cursor-not-allowed opacity-50"
          disabled
