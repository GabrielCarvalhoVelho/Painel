          ...
          <table className="min-w-full">
            <thead>
              <tr className="bg-[rgba(0,166,81,0.06)] rounded-t-2xl">
                <th className="px-1 py-4 text-left text-[14px] font-bold text-[#004417]">Categoria</th>
            ...
            <tbody>
              {custosSorted.map((item, index) => (
                <tr key={`ha-${index}`} className="bg-white border-b border-[rgba(0,0,0,0.06)]">
                  <td className="px-1 py-5 text-sm text-[#004417] font-medium align-top">{item.categoria}</td>
              ...
              <tr className="total-geral bg-[rgba(0,166,81,0.06)]">
                <td className="px-1 py-4 text-sm text-[#004417] font-bold">TOTAL GERAL</td>
